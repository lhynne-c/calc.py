...
def button_click(number):
    ...
    current = e.get()
    e.delete(0, END) # to delete the previous entry
...
button_clear = Button(root, text="Clear", padx=91, pady=20,  command= button_clear) #lambda not needed
...
button_clear.grid(row=5,  columnspan=6)
...
myButtton = Button(root, text = "Enter your Stock")
